...
void DrawSession::DrawRectangle(const int x, const int y, const int width, const int height,
                                const Color color) noexcept
{
    ::DrawRectangle(x, y, width, height, color);
}

void DrawSession::DrawTexture(const Texture2D &texture, const int x, const int y,
                              const Color color) noexcept
{
    ::DrawTexture(texture, x, y, color);
}

void DrawSession::DrawTexture(const Texture2D &texture, const float x, const float y,
                              const float width, const float height, const Vector2 &pos,
                              const Color color) noexcept
{
    ::DrawTextureRec(texture, {x, y, width, height}, pos, color);
}

void DrawSession::DrawTexture(const Texture2D &texture, const Rectangle &source, const Vector2 &pos,
                              const Color color) noexcept
{
    ::DrawTextureRec(texture, source, pos, color);
}

void DrawSession::DrawTexturePro(const Texture2D &texture, const Rectangle &source,
                                 const Rectangle &dest, const Vector2 &origin, const float scale,
                                 const Color color) noexcept
{
...
void DrawSession::DrawTextureEx(const Texture2D &texture, const float x, const float y,
                                const float scale, const Color color) noexcept
{
    ::DrawTextureEx(texture, Vector2{x, y}, 0.0f, scale, color);
}

void DrawSession::DrawText(const std::string &text, const int x, const int y, const int fontSize,
                           const Color color) noexcept
{
    ::DrawText(text.c_str(), x, y, fontSize, color);
}

void DrawSession::DrawTextCentered(const std::string &text, const int x, const int y,
                                   const int fontSize, const Color color) noexcept
{
...
void DrawSession::DrawFPS(const int posX, const int posY, const int height)
{
    ...
    const std::string fpsStr =
        std::format("FPS: {}", fps); // Use local fps instead of calling GetFPS() again
    DrawText(fpsStr, posX, posY, height, color);
}

void DrawSession::DrawCircle(const float centerX, const float centerY, const float radius,
                             const Color color) noexcept
{
